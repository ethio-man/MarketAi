...
import { BarChart2, ListChecks, ChevronDown, User } from "lucide-react";
...
const Dashboard = () => {
  return (
    <div className="flex-1 min-h-screen bg-gray-50 p-4 md:p-8 overflow-y-auto">
      <header className="flex flex-col gap-4 pb-6 border-b border-gray-200 mb-8 md:flex-row md:justify-between md:items-center">
        <div className="text-left">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-800">
            Insights & Analytics
          </h2>
          <p className="text-gray-500 mt-1">
            AI-powered digital marketing assistant for Ethiopian entrepreneurs.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        >
          <div className="space-y-4">
            ...
            <ProgressBar label="Textiles" value={70} colorClass="bg-blue-500" />
            <ProgressBar
              label="Leather Goods"
              value={45}
              colorClass="bg-blue-500"
        ...
        >
          <ul className="space-y-3 text-gray-600">
            ...
            <li className="flex items-start">
              <span className="text-green-500 mr-2 mt-1">✓</span>
              New entrant "Ethiopian Crafts Co." is gaining traction on
              Instagram.
            </li>
            <li className="flex items-start">
              <span className="text-green-500 mr-2 mt-1">✓</span>
